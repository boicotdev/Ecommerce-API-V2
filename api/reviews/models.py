...
class ProductReview(models.Model):
    ...
    responses = models.ManyToManyField('users.Comment', related_name='user_responses', blank=True, null=True)
    response = models.ForeignKey('reviews.ReviewResponse', on_delete=models.CASCADE, blank=True, null=True)
    
    def __str__(self) -> str:
        return f'Comment from {self.user.first_name} - {self.rated_at}'
...
class ReviewResponse(models.Model):
    ...
    def __str__(self) -> str:
        return f'Review Response from: {self.user.first_name}'
