...
class Payment(models.Model):
    ...
    payment_id = models.BigIntegerField(unique=True, null=True, blank=True) # ID de pago de MP
    mercado_pago_order_id = models.CharField(max_length=50, default='None')  # order_id de MP
    ...
    payment_method = models.CharField(max_length=30, choices=PAYMENT_METHODS, default='ACCOUNT_MONEY')
